...
#ifndef UBERCORE_SWIFT_H
#define UBERCORE_SWIFT_H
...
///
/// \param tokenType String containing the token type.
///
/// \param expirationDate The expiration date for this access token
///
/// \param grantedScopes The scopes this token is valid for
///
- (nonnull instancetype)initWithTokenString:(NSString * _Nonnull)tokenString refreshToken:(NSString * _Nullable)refreshToken tokenType:(NSString * _Nullable)tokenType expirationDate:(NSDate * _Nullable)expirationDate grantedScopes:(NSArray<UBSDKScope *> * _Nonnull)grantedScopes OBJC_DESIGNATED_INITIALIZER;
...
/// The <code>token_type</code> parameter is not required for this initializer, however is supported.
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKCallbackURIType, "CallbackURIType", open) {
...
/// returns:
/// true if fallback enabled, false otherwise
@property (nonatomic) BOOL alwaysUseAuthCodeFallback;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKDeeplinkErrorType, "DeeplinkErrorType", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKDeeplinkFallbackType, "DeeplinkFallbackType", open) {
...
SWIFT_CLASS_NAMED("EatsAppStoreDeeplink")
@interface UBSDKEatsAppStoreDeeplink : UBSDKBaseDeeplink
...
SWIFT_CLASS_NAMED("EatsAuthenticationDeeplink")
@interface UBSDKEatsAuthenticationDeeplink : UBSDKBaseDeeplink
...
SWIFT_CLASS_NAMED("EatsNativeAuthenticator")
@interface UBSSOEatsNativeAuthenticator : UBSDKBaseAuthenticator
...
SWIFT_CLASS("_TtC8UberCore10UberButton")
@interface UberButton : UIButton
...
@interface UBSDKLoginButton : UberButton
...
typedef SWIFT_ENUM(NSInteger, LoginButtonState, open) {
...
@class UBSDKUberAuthenticationProductFlow;
...
///
/// \param productFlowPriority An ordered list of the Uber apps to use for authentication, if available.
///
///
/// returns:
/// An initialized LoginManager
- (nonnull instancetype)initWithAccessTokenIdentifier:(NSString * _Nonnull)accessTokenIdentifier keychainAccessGroup:(NSString * _Nullable)keychainAccessGroup loginType:(enum UBSDKLoginType)loginType productFlowPriority:(NSArray<UBSDKUberAuthenticationProductFlow *> * _Nonnull)productFlowPriority OBJC_DESIGNATED_INITIALIZER;
/// Create instance of login manager to authenticate user and retreive access token.
...
/// returns:
/// An initialized LoginManager
- (nonnull instancetype)initWithAccessTokenIdentifier:(NSString * _Nonnull)accessTokenIdentifier keychainAccessGroup:(NSString * _Nullable)keychainAccessGroup loginType:(enum UBSDKLoginType)loginType;
/// Create instance of login manager to authenticate user and retreive access token.
...
/// returns:
/// An initialized LoginManager
- (nonnull instancetype)initWithAccessTokenIdentifier:(NSString * _Nonnull)accessTokenIdentifier keychainAccessGroup:(NSString * _Nullable)keychainAccessGroup productFlowPriority:(NSArray<UBSDKUberAuthenticationProductFlow *> * _Nonnull)productFlowPriority;
/// Create instance of login manager to authenticate user and retreive access token.
/// Uses the Implicit Login Behavior
/// Authenticates using the main Uber rides product.
/// \param accessTokenIdentifier The access token identifier to use for saving the Access Token, defaults to Configuration.getDefaultAccessTokenIdentifier()
...
/// returns:
/// An initialized LoginManager
- (nonnull instancetype)initWithAccessTokenIdentifier:(NSString * _Nonnull)accessTokenIdentifier productFlowPriority:(NSArray<UBSDKUberAuthenticationProductFlow *> * _Nonnull)productFlowPriority;
/// Create instance of login manager to authenticate user and retreive access token.
/// Uses the Implicit Login Behavior & your Configuration’s keychain access group
/// Authenticates using the main Uber rides product.
/// \param accessTokenIdentifier The access token identifier to use for saving the Access Token, defaults to Configuration.getDefaultAccessTokenIdentifier()
...
/// returns:
/// An initialized LoginManager
- (nonnull instancetype)initWithLoginType:(enum UBSDKLoginType)loginType productFlowPriority:(NSArray<UBSDKUberAuthenticationProductFlow *> * _Nonnull)productFlowPriority;
/// Create instance of login manager to authenticate user and retreive access token.
/// Uses the provided LoginType, with the accessTokenIdentifier & keychainAccessGroup defined
/// in your Configuration
/// Authenticates using the main Uber rides product.
...
/// returns:
/// An initialized LoginManager
- (nonnull instancetype)initWithProductFlowPriority:(NSArray<UBSDKUberAuthenticationProductFlow *> * _Nonnull)productFlowPriority;
/// Create instance of login manager to authenticate user and retreive access token.
/// Uses the Native LoginType, with the accessTokenIdentifier & keychainAccessGroup defined
/// in your Configuration
/// Authenticates using the main Uber rides product.
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKLoginType, "LoginType", open) {
...
SWIFT_CLASS_NAMED("RidesAppStoreDeeplink")
@interface UBSDKRidesAppStoreDeeplink : UBSDKBaseDeeplink
/// Initializes an App Store Deeplink to bring the user to the appstore
///
/// returns:
/// An initialized AppStoreDeeplink
...
SWIFT_CLASS_NAMED("RidesAuthenticationDeeplink")
@interface UBSDKRidesAuthenticationDeeplink : UBSDKBaseDeeplink
/// Initializes an Authentication Deeplink to request the provided scopes
/// \param scopes An array of UberScopes you would like to request
///
///
...
/// UberAuthenticating object for authenticating a user via the native Uber rides app
SWIFT_CLASS_NAMED("RidesNativeAuthenticator")
@interface UBSSORidesNativeAuthenticator : UBSDKBaseAuthenticator
/// Creates a NativeAuthenticator using the provided scopes
/// \param request the URL request.
///
///
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, ScopeType, open) {
  ScopeTypeGeneral = 0,
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKAuthenticationErrorType, "UberAuthenticationErrorType", open) {
...
enum UberProductType : NSInteger;

/// Represents an uber product flow to authenticate with (wrapped as an object for Obj-C compatibility)
SWIFT_CLASS_NAMED("UberAuthenticationProductFlow")
@interface UBSDKUberAuthenticationProductFlow : NSObject
@property (nonatomic, readonly) enum UberProductType uberProductType;
- (nonnull instancetype)init:(enum UberProductType)uberProductType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


typedef SWIFT_ENUM(NSInteger, UberButtonColor, open) {
...
typedef SWIFT_ENUM(NSInteger, UberButtonColorStyle, open) {
...
typedef SWIFT_ENUM(NSInteger, UberProductType, open) {
/// The main Uber app for requesting rides.
  UberProductTypeRides = 0,
/// The UberEats app for food delivery.
  UberProductTypeEats = 1,
};
...
- (nonnull instancetype)initWithScopeString:(NSString * _Nonnull)scopeString OBJC_DESIGNATED_INITIALIZER;
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, UberScopeType, open) {
