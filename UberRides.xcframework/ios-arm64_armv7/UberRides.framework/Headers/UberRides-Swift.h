...
#ifndef UBERRIDES_SWIFT_H
#define UBERRIDES_SWIFT_H
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, ModalViewControllerButtonStyle, open) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, ModalViewControllerColorStyle, open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKProductGroup, "ProductGroup", open) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, RideRequestViewErrorType, open) {
...
@property (nonatomic, unsafe_unretained) UIViewController * _Nonnull presentingViewController;
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKRideStatus, "RideStatus", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKUpfrontFareComponentType, "UpfrontFareComponentType", open) {
/// Base fare
